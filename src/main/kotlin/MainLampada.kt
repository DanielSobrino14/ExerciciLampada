...
fun main() {
    val lampara1 = Lampara(encendida = false, identificador = "Menjador", intensidad = 0, color = "blanco")
    val lampara2 = Lampara(encendida = false, identificador = "Cuina", intensidad = 0, color = "blanco")
